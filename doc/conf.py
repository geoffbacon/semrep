...
# -*- coding: utf-8 -*-
#
# semrep documentation build configuration file, created by
...
latex_documents = [
  ('index', 'semrep.tex', 'semrep Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'semrep', 'semrep Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'semrep', 'semrep Documentation',
   'Ariel Rokem', 'semrep', 'One line description of project.',
   'Miscellaneous'),
]
